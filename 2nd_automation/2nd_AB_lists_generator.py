...
end_to_end_A_range = 1500
end_to_end_B_range = 4000

A_pair1 = np.arange(A_start, A_end, A_step)
A_pair2 = np.arange(A_start, A_end+A_step, A_step) + end_to_end_A_range
A_range_list = [[a,b] for a,b in zip(A_pair1, A_pair2)]

B_pair1 = np.arange(B_start, B_end, B_step)
B_pair2 = np.arange(B_start, B_end+B_step, B_step) + end_to_end_B_range
